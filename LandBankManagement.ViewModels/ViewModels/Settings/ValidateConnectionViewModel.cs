            ...
            try
            {
                using (var db = new SQLServerDb(connectionString))
                {
                    ...
                    if (await dbCreator.ExistsAsync())
                    {
                        ...
                        if (version != null)
                        {
                            if (version == SettingsService.DbVersion)
                            {
                            ...
                            {
                                Message = $"Database version mismatch. Current version is {version}, expected version is {SettingsService.DbVersion}. Please, recreate the database.";
