...
namespace LandBankManagement.Views
{
    ...
    /// </summary>
    public sealed partial class DocumentTypeView : Page
    {
        public DocumentTypeViewModel ViewModel { get; }
        public INavigationService NavigationService { get; }
        public DocumentTypeView()
        {
            ViewModel = ServiceLocator.Current.GetService<DocumentTypeViewModel>();
            NavigationService = ServiceLocator.Current.GetService<INavigationService>();
            this.InitializeComponent();
            ViewModel.DocumentTypeDetials.IsEditMode = true;
        }
