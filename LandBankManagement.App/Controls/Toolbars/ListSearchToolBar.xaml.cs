...
{
    public sealed partial class ListSearchToolBar : UserControl
    {
        public event ToolbarButtonClickEventHandler ButtonClick;
        public event TypedEventHandler<AutoSuggestBox, AutoSuggestBoxQuerySubmittedEventArgs> QuerySubmitted;

        public ListSearchToolBar()
        {
        ...
        //public static readonly DependencyProperty NewLabelProperty = DependencyProperty.Register(nameof(NewLabel), typeof(string), typeof(ListSearchToolBar), new PropertyMetadata("New"));
        //#endregion
        ...
        {
            var control = d as ListSearchToolBar;
            control.UpdateControl();
        }

        public static readonly DependencyProperty ToolbarModeProperty = DependencyProperty.Register("ToolbarMode", typeof(ListToolbarMode), typeof(ListSearchToolBar), new PropertyMetadata(ListToolbarMode.Default, ToolbarModeChanged));
        #endregion
        ...
        public static readonly DependencyProperty DefaultCommandsProperty = DependencyProperty.Register(nameof(DefaultCommands), typeof(string), typeof(ListSearchToolBar), new PropertyMetadata("new,select,refresh,search", DefaultCommandsChanged));
        #endregion
        ...
        public static readonly DependencyProperty QueryProperty = DependencyProperty.Register("Query", typeof(string), typeof(ListSearchToolBar), new PropertyMetadata(null));
        #endregion
