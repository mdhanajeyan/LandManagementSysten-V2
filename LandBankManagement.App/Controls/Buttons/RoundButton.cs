...
namespace LandBankManagement.Controls
{
    public sealed class RoundButton : Button
    {
        ...
        public new static readonly DependencyProperty CornerRadiusProperty = DependencyProperty.Register(nameof(CornerRadius), typeof(CornerRadius), typeof(RoundButton), new PropertyMetadata(new CornerRadius(0.2)));
        #endregion
    }
}
